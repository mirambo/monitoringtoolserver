...
//echo $name ;
   ...
   No,
   Name,MS,
   HOUR(sec_to_time(sum(TDiff))) AS Minutes,
   ROUND(HOUR(sec_to_time(sum(TDiff)))/60,2) AS Hours
   FROM data 
                    ...
                    <div class="row">
                        <div class="col-sm-12">
							...
							<div class="col-sm-12">
											...
											<center><div class="alert alert-success" role="alert"><b><?php echo $name;?>-- Applications Report </div></center>
										</div>
