...
$groupID = $_GET['group'];
   ...
   $query5 = "SELECT * FROM excel_perfomance";
...
<div class="container"> 
	<div class="row">
          ...
          <div class="row">
                                ...
                                <div class="col-sm-3" >
                                          <?php
                                                $query3 = "SELECT COUNT(*) AS TOTAL FROM excel_perfomance WHERE Status = 'Finished' AND grpNo = $groupID";
                                    ...
                                    <div class="col-sm-3" >
                                          <?php
                                                $query4 = "SELECT COUNT(*) AS TOTAL FROM excel_perfomance WHERE Status = 'Incomplete' AND grpNo = $groupID";
                  ...
                  <div class="col-sm-3" >
                        <?php
                          $query1 = "SELECT COUNT(*) AS TOTAL FROM excel_perfomance WHERE Status = 'Average'  AND grpNo = $groupID";
                        ...
                        ?>
                          ...
                          <div class="col-sm-3" >
                          <?php
                                $query2 = "SELECT COUNT(*) AS TOTAL FROM excel_perfomance WHERE Status = 'Absent' AND grpNo = $groupID";
    ...
    <div class="row">
        ...
        <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
			  ...
			  $result3 = mysqli_query($connection,"SELECT * FROM excel_perfomance  WHERE grpNo = $groupID" );
