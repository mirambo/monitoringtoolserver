...
<div class="wrapper">
  ...
  <div class="row">
    <div class="col-sm-11">
       <center><div class="alert alert-success" role="alert"><b>SERVERS</b><br> SELECT A SERVER TO PULL REPORT</div></center>
    </div>
          ...
          <div class="row">
            <div class="col-sm-10">
            <center>      <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
                                <thead>
                                <tr>
                                ...
                                $result3 = mysqli_query($connection,"SELECT servers,batch,grpNo FROM  data  WHERE batch = $batch AND grpNo = $groupID GROUP BY servers" );
                                    while($row3 = mysqli_fetch_array($result3)) {
                                ?>
                                <tr>

                                <td><a href="dashboard.php?servername=<?php echo $row3['0']; ?>&batch=<?php echo $batch?>&grp=<?php echo $groupID; ?>"><?php echo $row3['0']; ?></a></td>		 
