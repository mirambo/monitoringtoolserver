                ...
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
							...
							<div class="container">
							<center><a href="ms.php?servername=<?php echo $servername; ?>&group=<?php echo $group; ?>&batch=<?php echo $batch; ?>"><button type="submit" class="btn btn-info"><b>Ms Word </b></button></a>                  
							<a href="excel.php?servername=<?php echo $servername; ?>&group=<?php echo $group; ?>&batch=<?php echo $batch; ?>"><button type="submit" class="btn btn-info"><b>Ms Excel </b></button></a> 
							<a href="ppt.php?servername=<?php echo $servername; ?>&group=<?php echo $group; ?>&batch=<?php echo $batch; ?>"><button type="submit" class="btn btn-info"><b>Ms PowerPoint </b></button></a>
							<a href="scratch.php?servername=<?php echo $servername; ?>&group=<?php echo $group; ?>&batch=<?php echo $batch; ?>"><button type="submit" class="btn btn-info"><b>Scratch</b></button></a>
							<a href="rogic.php?servername=<?php echo $servername; ?>&group=<?php echo $group; ?>&batch=<?php echo $batch; ?>"><button type="submit" class="btn btn-info"><b>Rogic</b></button></a>
							<a href="hourofcode.php?servername=<?php echo $servername; ?>&group=<?php echo $group; ?>&batch=<?php echo $batch; ?>"><button type="submit" class="btn btn-info"><b>Hour of CODE</b></button></a>
							<a href="#"><button type="submit" class="btn btn-info"><b>Ms Publisher </b></button></a>
							<a href="#"><button type="submit" class="btn btn-info"><b>Rachel </b></button></a></center>
